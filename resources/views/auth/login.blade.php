...
<div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-400 rounded-lg shadow-lg">
    ...
    <form class="mt-4" method="POST" action="">
        ...
        @enderror
        <button type="submit" class="rounded-md bg-green-600 w-full text-lg text-white font-bold p-2 my-3 hover:bg-green-500"><i class="fa fa-sign-in-alt"></i> Ingresar</button>
    </form>
</div>
@endsection