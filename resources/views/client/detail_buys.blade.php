...
@section('title', 'Detail Buy')

@section('content')
<div class="row px-16">
    <h1 class="text-5xl font-bold text-center pt-10 pb-10">Detalle de la Compra</h1>
    @if (count($sales) > 0)
    <div class="bg-gray-100 relative overflow-x-auto sm:rounded-lg">
        ...
        <div class="text-center pt-5 pb-5">
            <a href="{{ route('catalog.shopping') }}" type="button" class="rounded-md bg-blue-600 w-auto text-lg text-white font-bold py-2 px-4 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300"><i class="fa fa-undo-alt"></i> Regresar</a>
        </div>
    </div>
    @else
